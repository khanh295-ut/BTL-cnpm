...
% ==== LE TRANG (Chuẩn báo cáo Việt Nam) ====
\geometry{
  top=30mm,
  bottom=25mm,
  left=35mm,
...
\hypersetup{
  ...
  pdftitle={Đồ án CNPM - AIConnect Platform}
}
...
% ----- CHUYỂN SANG SỐ TRANG CHỮ SỐ Ả RẬP (Nội dung chính) -----
